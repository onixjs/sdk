...
define('documentation', [
  ...
  'http',
  'path',
], function(require, exports, serveStatic, finalhandler, http, path) {
  'use strict';
...
define('core/listener.collection', [
  'require',
  'exports',
  'interfaces/index',
...
define('core/client.registration', ['require', 'exports'], function(
  require,
  exports,
) {
  'use strict';
...
define('core/unsubscribe', ['require', 'exports', 'utils/index'], function(
  require,
  exports,
  utils_1,
) {
...
define('core/method.reference', [
  'require',
  'exports',
  'utils/index',
  'core/unsubscribe',
], function(require, exports, utils_2, unsubscribe_1) {
  'use strict';
  Object.defineProperty(exports, '__esModule', {value: true});
  /**
  ...
  class MethodReference {
      ...
      return __awaiter(this, void 0, void 0, function*() {
        return new Promise((resolve, reject) => {
          if (this.invalid('rpc')) {
            ...
            const listenerId = this.componentReference.moduleReference.appReference.config.listeners.add(
              response => {
                if (
                  response.uuid === operation.uuid &&
                  response.type === 14 /* ONIX_REMOTE_CALL_PROCEDURE_RESPONSE */
                ) {
    ...
    stream(listener, filter) {
      if (this.invalid('stream')) {
        ...
        const id = this.componentReference.moduleReference.appReference.config.listeners.add(
          response => {
            if (
              response.uuid === operation.uuid &&
        ...
        return new unsubscribe_1.Unsubscribe(
          id,
          operation,
...
define('core/component.reference', [
  'require',
  'exports',
  'core/method.reference',
], function(require, exports, method_reference_1) {
  'use strict';
  Object.defineProperty(exports, '__esModule', {value: true});
  /**
   * @class ModuleReference
...
define('core/module.reference', [
  'require',
  'exports',
  'core/component.reference',
], function(require, exports, component_reference_1) {
  'use strict';
  Object.defineProperty(exports, '__esModule', {value: true});
  /**
   * @class ModuleReference
  ...
  class ModuleReference {
    ...
    Component(name) {
      if (!this.components[name])
        this.components[name] = new component_reference_1.ComponentReference(
          name,
          this,
        );
...
define('core/app.reference', [
  'require',
  'exports',
  'core/module.reference',
], function(require, exports, module_reference_1) {
  'use strict';
  Object.defineProperty(exports, '__esModule', {value: true});
  class AppReference {
    // Todo Client
...
define('core/index', [
  ...
  'core/component.reference',
  'core/method.reference',
  'core/listener.collection',
], function(
  require,
  exports,
  app_reference_1,
  module_reference_2,
  component_reference_2,
  method_reference_2,
  listener_collection_1,
) {
  'use strict';
  function __export(m) {
...
define('index', [
  ...
  class OnixClient {
    ...
    init() {
      return __awaiter(this, void 0, void 0, function*() {
        // Get OnixJS Schema
        this.schema = yield this.http.get(
        ...
        return new Promise((resolve, reject) => {
          ...
          this.ws.on('message', data =>
            this.listeners.broadcast(
              utils_3.Utils.IsJsonString(data) ? JSON.parse(data) : data,
            ),
          );
    ...
    register(resolve, reject) {
      ...
      const index = this.listeners.add(data => {
        ...
        const response =
          typeof data === 'string' && utils_3.Utils.IsJsonString(data)
            ? JSON.parse(data)
            : data;
        ...
        if (
          ...
          if (
            ...
            this.registration = new client_registration_1.ClientRegistration(
              uuid,
            );
    ...
    AppReference(name) {
      return __awaiter(this, void 0, void 0, function*() {
        ...
        if (!this.references[name]) {
          ...
          this.references[name] = new app_reference_2.AppReference(
            Object.assign(
              {
                name,
                client: this.ws,
    ...
    claims() {
      return __awaiter(this, void 0, void 0, function*() {
        ...
        if (this.token.length > 0) {
          ...
          const claims = yield this.http.get(
...
define('adapters/browser.adapters', [
  'require',
  'exports',
  'utils/index',
], function(require, exports, utils_4) {
  'use strict';
  Object.defineProperty(exports, '__esModule', {value: true});
        ...
        switch (name) {
          case 'message':
            this.connection.onmessage = event => {
              callback(
                utils_4.Utils.IsJsonString(event.data)
...
define('adapters/nativescript.adapters', ['require', 'exports'], function(
  require,
  exports,
) {
  'use strict';
...
define('adapters/node.adapters', [
  ...
  'utils/index',
  'node-localstorage',
], function(require, exports, WS, http, https, utils_5, node_localstorage_1) {
  'use strict';
  Object.defineProperty(exports, '__esModule', {value: true});
  /**
   * @namespace NodeJS
        ...
        return __awaiter(this, void 0, void 0, function*() {
          return new Promise((resolve, reject) => {
            const cb = res => {
              ...
              res.on('end', () =>
                resolve(
                  utils_5.Utils.IsJsonString(body) ? JSON.parse(body) : body,
                ),
              );
              // Rehect on error
            };
